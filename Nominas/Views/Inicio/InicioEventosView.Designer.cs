...
partial class InicioEventosView
{
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle.Size = new Size(544, 50);
        lblTitle.TabIndex = 1;
        lblTitle.Text = "Eventos";
        ...
        lblPlaceholder.Size = new Size(544, 496);
        lblPlaceholder.TabIndex = 0;
        lblPlaceholder.Text = "Aquí irá el contenido de Eventos\n(Traer formulario desde VB.NET)";
        ...
        Name = "InicioEventosView";
        Size = new Size(544, 546);
        ResumeLayout(false);
    }
}
